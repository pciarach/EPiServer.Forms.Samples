...
(function ($) {
    ...
    $.extend(DateTimePicker.prototype, {
        ...
        _setDate: function (inst, date, noChange) {
            ...
            if ((origMonth !== inst.selectedMonth || origYear !== inst.selectedYear) && !noChange) {timepicker
                this._notifyChange(inst);
            }
            this._adjustInstDate(inst);
            if (inst.input) {
        ...
        _selectHourMinutePeriod: function (id) {
            ...
            onSelect = this._get(inst, "onSelect");
            if (onSelect) {
                onSelect.apply((inst.input ? inst.input[0] : null), [timeStr, inst]);  // trigger custom callback
            } else if (inst.input) {
                inst.input.trigger("change"); // fire the change event
            }
        },
