...
dotnet pack --no-restore --no-build --output ../nupkgs -c $configuration /p:Version=$pVersion  /p:FormsVersion=$formsVersion /p:FormsNextMajorVersion=$formsNextMajorVersion /p:CoreVersion=$coreVersion ../EPiServer.Forms.Samples.sln
